...
**Tujuan:** Single pane of glass for management to monitor ALL procurement activities in real-time  
**Pengguna Target:** BOD, GM Pengembangan Usaha, Marketing dan Pengadaan, Direktur Keuangan, SDM dan Umum, Manager Pengadaan  
**Frekuensi Pembaruan:** Real-time (WebSocket, sub-second latency)  
**Tampilan:** Large format (43"+ monitors, wall-mounted or control room)

---

## TATA LETAK DASHBOARD (Tampilan Pusat Komando)
...
│  Spent: 4,200M              │  │  SJPH: 5 received      │  ├─ Invoice mismatch│
...
│  Vendor Quality: 4.3/5.0    │  │  SJPH: 3 received      │  ├─ Budget threshold│
│                             │  │  Status: 🟡 EVAL        │  │  at 90%          │
...
│  ✓ Vendor Performance: OK   │  │  SJPH: 2 received      │  [ACK] [CLOSE]      │
...
│  ├─ TND-2025-0021 (8 days)  │  14:21:15 SJPH evaluated   │  Email Service:      │
...
**Display Format:**
```
Tender Number | Item | Budget | SLA Days | SJPH | Status
──────────────────────────────────────────────────────────
...
🟠 HIGH - 14:15 - SLA Breach Warning
   ...
   Closing in 1 day, only 2 sjph received
   Expected 4-5 sjph. Vendor reach-out in progress.
   [ACK] [CLOSE]

🟡 MEDIUM - 14:05 - Invoice Mismatch
   INV-2025-001 | PO-2025-101
   BAPB: 100 units | Invoice: 105 units (5 unit variance)
   3-way match FAILED. Contact vendor for clarification.
   [ACK] [INVESTIGATE] [APPROVE_VARIANCE]

🟢 INFO - 13:45 - SJPH Extracted
   TND-2025-0019 | AI extracted sjph from PT Medik Jaya
...
14:31:45   | QUOTE      | TND-2025-0019| SJPH extracted (AI)  | ✅
...
**Filtering Options:**
- By Entity Type (Tender, SJPH, PO, Payment, Delivery)
...
### Database Queries for Pusat Komando
...
SELECT 
  ...
  (SELECT COUNT(*) FROM sjph WHERE tender_id = tenders.id) as quote_count,
  status,
  CASE 
...
1. Click on Tender → See all sjph + scores
...
## REKOMENDASI PERANGKAT KERAS TAMPILAN
...
- **Tampilan:** 27"+ QHD (2560x1440) or 4K
...
## LANGKAH SELANJUTNYA FOR IT IMPLEMENTATION
