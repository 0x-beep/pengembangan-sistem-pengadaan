...
✓ Instruksi-BidEvaluation.docx (SJPH evaluation)
...
```
USER ACTION:
Admin Pengadaan Umum tries to approve 350M PO
...
"Saya Admin Pengadaan Umum, bisa approve PO 300 juta?"

AI CHECKS:
├─ SOP-003 Approval Matrix: Who can approve what?
├─ Finds: "Admin Pengadaan Umum - CANNOT approve"
