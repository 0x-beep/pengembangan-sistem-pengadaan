...
**Tujuan:** AI continuously monitors all procurement activities against company procedures and provides real-time guidance when deviations occur  
**Status:** SPESIFIKASI - SIAP UNTUK IMPLEMENTASI  
**Pemilik:** Departemen Pengadaan Umum dan Jasa + IT  
  ...
  "steps": [
    {
      ...
      "responsible": "Admin Pengadaan Umum",
...
│ Required: ["invoice", "bapb"]         │
│ Attached: ["invoice", "bapb"] ✅      │
│                                      │
...
│                                                              │
│ AI: Instruksi berdasarkan wewenang Kepala Bagian Keuangan...    │
│     approve a PO:                                           │
│                                                              │
...
## PEMANTAUAN KEPATUHAN & PERINGATAN
...
SOP-002 (SJPH Evaluation):     ✅ 95% adherence
...
```
User: "Saya Admin Pengadaan Umum, bisa approve PO 300 juta?"

AI: Berdasarkan SOP-003 Step 3 Approval Matrix:

Admin Pengadaan Umum TIDAK dapat approve PO.
Role yang bisa approve:
- Kepala Bagian Keuangan: Untuk PO 100M-500M ✓ (300M in range)
- Director: Untuk PO >500M

Anda (Admin Pengadaan Umum) bertanggung jawab untuk:
...
├─────────────────────────────────────────┤
│                                         │
│ Your role (Admin Pengadaan Umum) is NOT  │
