...
CREATE INDEX idx_quotes_calculated_score ON quotes(calculated_score);
CREATE INDEX idx_quotes_selected ON quotes(selected);
...
-- View: Active Tenders with Quote Counts
...
FROM tenders t
LEFT JOIN quotes q ON t.id = q.tender_id
